...
namespace Datadog.Trace.ClrProfiler.AutoInstrumentation.Redis.ServiceStack
{
    ...
    public class RedisNativeClientSendReceiveIntegration
    {
        ...
        {
            Scope scope = RedisHelper.CreateScope(Tracer.InternalInstance, IntegrationId, IntegrationName, instance.Host ?? string.Empty, instance.Port.ToString(CultureInfo.InvariantCulture), RedisHelper.GetRawCommand(cmdWithBinaryArgs));
