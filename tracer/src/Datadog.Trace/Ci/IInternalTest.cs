// <copyright file="IInternalTest.cs" company="Datadog">
...
internal interface IInternalTest
{
    ...
    /// Set Test parameters
    /// </summary>
    /// <param name="arguments">Test arguments</param>
    /// <param name="metadata">Test metadata</param>
    void SetParameters(Dictionary<string, object>? arguments, Dictionary<string, object>? metadata);
    ...
    void Close(int status, TimeSpan? duration, string? skipReason);
}
