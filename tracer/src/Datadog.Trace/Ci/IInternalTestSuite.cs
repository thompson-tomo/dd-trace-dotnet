// <copyright file="IInternalTestSuite.cs" company="Datadog">
...
/// </summary>
internal interface IInternalTestSuite
{
    /// <summary>
    ...
    /// <returns>Test instance</returns>
    object CreateTest(string name, DateTimeOffset startDate);
}
